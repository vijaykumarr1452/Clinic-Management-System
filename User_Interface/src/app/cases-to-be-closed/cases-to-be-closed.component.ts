...
@Component({
  selector: 'app-cases-to-be-closed',
  templateUrl: './cases-to-be-closed.component.html',
  styleUrls: ['./cases-to-be-closed.component.scss']
})
export class CasesToBeClosedComponent implements OnInit {
