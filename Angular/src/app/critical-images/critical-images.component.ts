...
@Component({
  selector: 'app-critical-images',
  templateUrl: './critical-images.component.html',
  styleUrls: ['./critical-images.component.scss']
})
export class CriticalImagesComponent implements OnInit {
